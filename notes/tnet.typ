...
#definition([Pauli Group and Stabilizer Group], [A _stabilizer group_ $cal(S)$ is an Abelian subgroup of the $n$-qubit Pauli group. The $n$-qubit pauli group is the group generated by the $n$-qubit Pauli matrices
$
